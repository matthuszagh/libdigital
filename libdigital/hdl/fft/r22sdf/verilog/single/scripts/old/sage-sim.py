...
for t in range(1, T):
    ...
    for s in range(Nstages):
        ...
        for n in range(1, max_fsr_bf2 + 1):  # shift reg values
            set_var(
                "s{}bf2_fsr{}_t{}".format(s, n, t),
                get_var("s{}bf2_fsr{}_t{}".format(s, n - 1, t - 1)),
            )

        if get_var("sel_s{}bf2_t{}".format(s, t)) == 0:
            set_var("s{}bf2_fsr{}_t{}".format(s, 0, t), prev_stage_out)
            set_var(
                "s{}bf2_out_t{}".format(s, t),
                get_var("s{}bf2_fsr{}_t{}".format(s, max_fsr_bf2, t - 1)),
            )
        elif (
            get_var("sel_s{}bf2_t{}".format(s, t)) == 1
            and get_var("sel_s{}bf1_t{}".format(s, t)) == 1
        ):
            set_var(
                "s{}bf2_fsr{}_t{}".format(s, 0, t),
                get_var("s{}bf2_fsr{}_t{}".format(s, max_fsr_bf2, t - 1))
                - prev_stage_out,
            )
            set_var(
